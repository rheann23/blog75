...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/fYsSoDDYy/model.json',modelLoaded);
...
function speak(){
    ...
    speak_data_2 = "second predicition is"+predicition_2;
